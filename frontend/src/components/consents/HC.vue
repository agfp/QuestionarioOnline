...
<div class="texto">
    <p>
        Este é um convite para você participar da pesquisa, <i>"Identificação e análise de condições de trabalho e
        riscos psicossociais em trabalhadores de uma organização hospitalar"</i>, coordenada pela Profa. Dra. Lívia de
    ...
    <p>
        ...
        e ausência ao trabalho. Caso você aceite o convite, poderá responder ao questionário: <i>"Avaliação das condições
        de trabalho"</i>, considerando quatro grandes categorias: condições contratuais e jurídicas, condições físicas e
        materiais, processos e características das atividades, e condições do ambiente sociogerencial. E também ao
        questionário: <i>"Avaliação do estresse no trabalho"</i>, de acordo com o Modelo de Demanda e Controle.
    </p>
    <p>
    ...
    <p>
        ...
        realizada, os riscos e benefícios envolvidos e concorda em participar voluntariamente da pesquisa <i>"Identificação
        e análise de condições de trabalho e riscos psicossociais em trabalhadores de uma organização hospitalar"</i>.
    </p>
    <div class="pure-g">
        <div class="pure-u-1-2 signature">
            <p>
                <span class="bold">Profa. Dra. Livia de Oliveira Borges</span><br /> Coordenadora
            </p>
        </div>
        <div class="pure-u-1-2 signature">
            <p>
                <span class="bold">Geraldo Majela Garcia Primo</span><br /> Doutorando
            </p>
        </div>
    </div>
    <p>
        <span class="bold">Endereço:</span> Departamento de Psicologia, da Faculdade de Filosofia e Ciências Humanas (FAFICH) da Universidade Federal de Minas Gerais (UFMG), Sala 4100. Campus Pampulha. Av. Antônio Carlos, 6627. CEP 31270-901. Telefone:
        (31) 3409-6266
    </p>
    <p>
        <span class="bold">Comitê de Ética e Pesquisa:</span> Av. Antônio Carlos, 6627, Unidade Administrativa II - 2º andar - Sala 2005. Campus Pampulha. Belo Horizonte, MG. CEP 31270-901. Telefone: (31) 3409-4592
    </p>
</div>
</template>
